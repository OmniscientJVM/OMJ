...
class ParserTest {
  ...
  void testArrayIntVoid() {
    assertEquals(
        new ParsedMethodDescriptor(Arrays.asList('L'), 'V'), Parser.parseMethodDescriptor("([I)V"));
  }

  @Test
  void testArrayArrayIntVoid() {
    assertEquals(
        new ParsedMethodDescriptor(Arrays.asList('L'), 'V'),
        Parser.parseMethodDescriptor("([[I)V"));
  }
  ...
  void testEmptyArrayArrayInt() {
    assertEquals(
        new ParsedMethodDescriptor(Arrays.asList(), 'L'), Parser.parseMethodDescriptor("()[[I"));
  }
  ...
  void testEmptyRef() {
    assertEquals(
        new ParsedMethodDescriptor(Arrays.asList(), 'L'),
