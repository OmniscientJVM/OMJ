...
class ParserTest {
    ...
    @Test
    void testEmptyVoid() {
        assertEquals(new ParsedMethodDescriptor(Collections.emptyList(), 'V'),
                     Parser.parseMethodDescriptor("()V"));
    }

    @Test
    void testByteVoid() {
        assertEquals(new ParsedMethodDescriptor(Collections.singletonList('B'), 'V'),
                     Parser.parseMethodDescriptor("(B)V"));
    }

    @Test
    void testCharVoid() {
        assertEquals(new ParsedMethodDescriptor(Collections.singletonList('C'), 'V'),
                     Parser.parseMethodDescriptor("(C)V"));
    }

    @Test
    void testDoubleVoid() {
        assertEquals(new ParsedMethodDescriptor(Collections.singletonList('D'), 'V'),
                     Parser.parseMethodDescriptor("(D)V"));
    }

    @Test
    void testFloatVoid() {
        assertEquals(new ParsedMethodDescriptor(Collections.singletonList('F'), 'V'),
                     Parser.parseMethodDescriptor("(F)V"));
    }

    @Test
    void testIntVoid() {
        assertEquals(new ParsedMethodDescriptor(Collections.singletonList('I'), 'V'),
                     Parser.parseMethodDescriptor("(I)V"));
    }

    @Test
    void testLongVoid() {
        assertEquals(new ParsedMethodDescriptor(Collections.singletonList('J'), 'V'),
                     Parser.parseMethodDescriptor("(J)V"));
    }

    @Test
    void testShortVoid() {
        assertEquals(new ParsedMethodDescriptor(Collections.singletonList('S'), 'V'),
                     Parser.parseMethodDescriptor("(S)V"));
    }

    @Test
    void testBooleanVoid() {
        assertEquals(new ParsedMethodDescriptor(Collections.singletonList('Z'), 'V'),
                     Parser.parseMethodDescriptor("(Z)V"));
    }

    @Test
    void testIntDoubleVoid() {
        assertEquals(new ParsedMethodDescriptor(Arrays.asList('I', 'D'), 'V'),
                     Parser.parseMethodDescriptor("(ID)V"));
    }

    @Test
    void testIntDoubleShort() {
        assertEquals(new ParsedMethodDescriptor(Arrays.asList('I', 'D'), 'S'),
