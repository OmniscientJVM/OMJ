...
class OMJClassFileTransformer(
    ...
    class Transformer {
        ...
        internal fun transformClassBytes(classfileBuffer: ByteArray): ByteArray {
            ...
            val methodsAndLocals = localVariableClassVisitor.localVariableVisitors
                .mapValues { it.value.locals.toList() }

            logger.debug {
                """
                Computed methods and locals:
                ${methodsAndLocals.entries.joinToString("\n") { (method, locals) ->
                    """
                    Method = $method
            ...
            classReader.accept(OMJClassAdapter(ASM8, trace), 0)

            OMJKoinContext.koinApp.koin.unloadModules(listOf(localsModule))
